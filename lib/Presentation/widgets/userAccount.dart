...
class UserAccountWidget extends StatefulWidget {
  ...
  const UserAccountWidget({super.key, required this.navigatorKey});
...
class _UserAccountWidgetState extends State<UserAccountWidget> {
  ...
  void initState() {
    ...
    _lastNameController.text = DataProvider.lastName;
    _firstNameController.text = DataProvider.firstName;
    _companyController.text = DataProvider.company;
    _emailController.text = DataProvider.email;
    _phoneController.text = DataProvider.number;
